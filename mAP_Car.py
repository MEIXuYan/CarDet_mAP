...
GT_PATH = os.path.join(os.getcwd(), 'input_car', 'ground-truth')
DR_PATH = os.path.join(os.getcwd(), 'input_car', 'detection-results')
# if there are no images then no animation can be shown
IMG_PATH = os.path.join(os.getcwd(), 'input_car', 'images-optional')
